  ...
  reviews = [
    {
      ...
      comment:
        'This is a sample comment . It holds no meaning and it is only written here to just fill up space for some text. But its nice to know that you have read the whole comment seriously ',
      date: '27-05-2019',
      rating: 3
    },
    {
